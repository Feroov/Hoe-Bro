...
import com.hoebro.entity.ai.IronHoeAI;
...
public class IronHoe extends PathAwareEntity
{
    public final AnimationState idleAnimationState = new AnimationState();
    private int idleAnimationTimeout = 0;
    private boolean deliverToChestMode = false;

    public IronHoe(EntityType<? extends PathAwareEntity> entityType, World world)
    {
    ...
    protected void initGoals()
    {
        ...
        this.goalSelector.add(1, new IronHoeAI(this, 1.35f, 15, 15, 200));
