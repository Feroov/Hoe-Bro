...
public class DiamondHoeModel<T extends DiamondHoe> extends SinglePartEntityModel<T>
{
    private final ModelPart stonehoe;
    private final ModelPart upperbody;

    public DiamondHoeModel(ModelPart root)
    {
    ...
    @Override
    public void setAngles(DiamondHoe entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
