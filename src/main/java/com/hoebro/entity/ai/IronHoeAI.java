...
public class IronHoeAI extends Goal
{
    private final IronHoe hoeEntity;
    ...
    public IronHoeAI(IronHoe hoeEntity, double speed, int sightRange, int chestSightRange, int durability)
    {
    ...
    private void moveToPlayer()
    {
        ...
        if (nearestPlayer != null)
        {
            ...
            // Check if the IronHoe entity is close enough to the player to deliver the items.
    ...
    private void deliverToPlayer(PlayerEntity player)
    {
        if (!this.world.isClient)
        {
            ...
            for (ItemStack stack : new ArrayList<>(itemsToDeliver))
            {
                // Create a new ItemEntity at the IronHoe entity's location with the item stack.
