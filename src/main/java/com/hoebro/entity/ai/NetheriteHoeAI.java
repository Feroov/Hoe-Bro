...
public class NetheriteHoeAI extends Goal
{
    private final NetheriteHoe hoeEntity;
    ...
    public NetheriteHoeAI(NetheriteHoe hoeEntity, double speed, int sightRange, int chestSightRange, int durability)
    {
    ...
    private void moveToPlayer()
    {
        ...
        if (nearestPlayer != null)
        {
            ...
            // Check if the NetheriteHoe entity is close enough to the player to deliver the items.
    ...
    private void deliverToPlayer(PlayerEntity player)
    {
        if (!this.world.isClient)
        {
            ...
            for (ItemStack stack : new ArrayList<>(itemsToDeliver))
            {
                // Create a new ItemEntity at the NetheriteHoe entity's location with the item stack.
