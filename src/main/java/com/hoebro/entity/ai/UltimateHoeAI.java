...
public class UltimateHoeAI extends Goal
{
    private final UltimateHoe hoeEntity;
    ...
    public UltimateHoeAI(UltimateHoe hoeEntity, double speed, int sightRange, int chestSightRange, int durability)
    {
    ...
    private void moveToPlayer()
    {
        ...
        if (nearestPlayer != null)
        {
            ...
            // Check if the UltimateHoe entity is close enough to the player to deliver the items.
    ...
    private void deliverToPlayer(PlayerEntity player)
    {
        if (!this.world.isClient)
        {
            ...
            for (ItemStack stack : new ArrayList<>(itemsToDeliver))
            {
                // Create a new ItemEntity at the UltimateHoe entity's location with the item stack.
